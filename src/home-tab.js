export {initialHomeLoad, createHeader};

const initialHomeLoad = () => {
    const contentDOM = document.querySelector('#content');
    contentDOM.classList.add('home-pg-style');
    ...
    contentDOM.appendChild(heading);
    contentDOM.appendChild(description);
};
